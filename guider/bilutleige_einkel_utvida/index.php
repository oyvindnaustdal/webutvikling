...
<body>
    ...
    <a href="index.php">Heim</a>
     <a href="kundar.php">Kunderegistrering</a>
     <a href="utleigd.php">Utleigde bilar</a>
    </nav>
    ...
    <table>
        ...
        while ($rad = $resultat->fetch_assoc()) {
           ...
           // Endre rad
            ...
            // Status
            echo "<td class='" . ($rad['status'] == 'Utleigd' ? 'status-utleigd' : 'status-ledig') . "'>" . $rad['status'] . "</td>";
            
            // Bestill bil
            echo "<td>";
            if ($rad['status'] == 'Utleigd') {
                echo "<span class='feilmelding'>Ikkje tilgjengeleg</span>";
            } else {
                echo "<a href='bestilling.php?id=" . $rad['id'] . "'><button>Bestill denne</button></a>";
            }
            echo "</td>";
